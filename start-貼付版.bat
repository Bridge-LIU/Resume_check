...
:main
REM ================================================
REM  Interview AI Evaluation Tool - Lite Launcher
REM  Paste-only mode. API mode UI is hidden.
REM  Use ChatGPT / Claude side for summary / questions / minutes / evaluation.
REM ================================================
...
echo.
echo ================================================
echo   Interview AI Evaluation Tool - LITE
